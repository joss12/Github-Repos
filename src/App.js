...
function App() {
  ...
  const fetchData = useCallback(() => {
    ...
    fetch(github.baseURL, {
      ...
      .then((data) => {
        ...
        const start = data.data.search.pageInfostartCursor;
        const end = data.data.search.pageInfoendCursor;
        const next = data.data.search.pageInfohasNextPage;
        const prev = data.data.search.pageInfohasPreviousPage;
  ...
  return (
    <div className="App container mt-5">
      ...
      <p>Hey there, my name is Eddy Mouity{userName}. Welcome to my github profile.</p>
      <SearchBox
